...
public class CameraActivity extends AppCompatActivity implements CameraBridgeViewBase.CvCameraViewListener2 {
    ...
    public void FrameCounter(int colorListIndex, int[] ortalama){
        ...
        else if(count%180==0){ //90 da iken 3,8 snde bir dönüyor 120 iken 4,5 sn bir dönüyor 250 10,6sn
            playProcess(colorListIndex);
    ...
    public void playProcess(int a){
        ...
        try {
            mediaPlayer = MediaPlayer.create(this, Uri.parse("android.resource://"+getPackageName()+"/raw/sarki"+a)); //sarki 1 kirmizi
            mediaPlayer.start();
